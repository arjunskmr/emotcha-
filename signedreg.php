...
$uid = substr(str_shuffle("0123ssdaasdadasdad456789abcdefghasdada2342ijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ"), 0, 5);
$conn = mysqli_connect ($servername, $username, $password, "emotcha_db");
  $userName = $_POST['uname'];
  $email = $_POST['email'];
  $password =  $_POST['pass'];
  $cpassword =  $_POST['cpass'];
  $query = "INSERT INTO user_cred(username,email,password,appid,appsecret,calls,uid) VALUES ('$userName','$email','$password','$appid','$appsecret','$calls','$uid')";
